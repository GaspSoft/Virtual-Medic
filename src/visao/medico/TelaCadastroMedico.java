	...
	public TelaCadastroMedico() {
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (inserir) {
					TelaMensagem telaSucesso = new TelaMensagem(nome + " cadastrado com sucesso!", "Cadastro realizado", new Color(0,139,139));
					telaSucesso.setVisible(true);
				} else {
					TelaMensagem telaSucesso = new TelaMensagem("Não foi possível cadastrar o médico!", "Erro ao cadastrar", new Color(139,0,0));
					telaSucesso.setVisible(true);
				}
			}
		});
