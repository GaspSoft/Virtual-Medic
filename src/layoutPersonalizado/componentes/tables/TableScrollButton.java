package layoutPersonalizado.componentes.tables;
...
public class TableScrollButton extends JLayeredPane {
    ...
    private class ScrollLayerUI extends LayerUI<JScrollPane> {
        ...
        private final Image image = new ImageIcon(getClass().getResource("/layoutPersonalizado/componentes/tables/up.png")).getImage();
